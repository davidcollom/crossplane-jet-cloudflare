...
func (tr *SettingsOverride) GetObservation() (map[string]interface{}, error) {
...
func (tr *SettingsOverride) SetObservation(obs map[string]interface{}) error {
...
func (tr *SettingsOverride) GetParameters() (map[string]interface{}, error) {
...
func (tr *SettingsOverride) SetParameters(params map[string]interface{}) error {
