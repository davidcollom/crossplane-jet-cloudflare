...
func (tr *Lockdown) GetObservation() (map[string]interface{}, error) {
...
func (tr *Lockdown) SetObservation(obs map[string]interface{}) error {
...
func (tr *Lockdown) GetParameters() (map[string]interface{}, error) {
...
func (tr *Lockdown) SetParameters(params map[string]interface{}) error {
