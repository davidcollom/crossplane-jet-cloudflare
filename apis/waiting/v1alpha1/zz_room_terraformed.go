...
func (tr *Room) GetObservation() (map[string]interface{}, error) {
...
func (tr *Room) SetObservation(obs map[string]interface{}) error {
...
func (tr *Room) GetParameters() (map[string]interface{}, error) {
...
func (tr *Room) SetParameters(params map[string]interface{}) error {
