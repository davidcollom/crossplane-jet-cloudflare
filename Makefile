...
export TERRAFORM_PROVIDER_VERSION := 3.10.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-cloudflare
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-cloudflare/3.10.1
